...
<head>
    ...
    <meta name="description" content="Информация по обработке персональных данных Пользователя сайтом TrueTWS.ru!"/>
    <meta name="keywords" content="политика конфиденциальности, обработка персональных данных"/>
    <meta http-equiv="X-UA-Compatible" content="IE=edge"/>
    <link rel="stylesheet" href="styles/bootstrap.min.css"/>
    <link rel="stylesheet" href="styles/sections/policy.min.css"/>
...
<div class="wrapper">
    <div class="header">
        <div class="container">
            <a class="link-base" href="/">Главная</a>
        </div>
    </div>
    <main>
        <section class="policy-text">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h1 class="policy-text__title">Политика в отношении обработки персональных данных</h1>
                        <h3 class="policy-text__section">1. Общие положения</h3>
                        ...
                        администрацией сайта truetws.ru (далее – Оператор).
                        <ol>
                            ...
                            <li>Настоящая политика Оператора в отношении обработки персональных данных (далее –
                                ...
                                веб-сайта truetws.ru.
                            </li>
                        </ol>

                        <h3 class="policy-text__section">2. Основные понятия, используемые в Политике</h3>
                        <ol>
                            ...
                            <li>Персональные данные – любая информация, относящаяся прямо или косвенно к определенному
                                или определяемому Пользователю веб-сайта truetws.ru;
                            </li>
                            <li>Пользователь – любой посетитель веб-сайта truetws.ru;</li>
                        ...
                        <h3 class="policy-text__section">3. Оператор может обрабатывать следующие персональные данные
                            Пользователя</h3>
                        <ol>
                        ...
                        <h3 class="policy-text__section">4. Цели обработки персональных данных</h3>

                        <ol>
                            <li>Цель обработки персональных данных Пользователя — установление с Пользователем обратной
                                связи, включая направление уведомлений, запросов, касающихся использования сайта,
                                оказания услуг, обработка запросов и заявок от Пользователя, уведомление Пользователя
                                сайта о состоянии заказа.
                            </li>
                            <li>Также Оператор имеет право направлять Пользователю уведомления о новых продуктах и
                                ...
                                электронной почты admin@truetws.ru с пометкой «Отказ от уведомлениях о новых продуктах и
                        ...
                        <h3 class="policy-text__section">5. Правовые основания обработки персональных данных</h3>
                        ...
                        <ol>
                            <li>Оператор обрабатывает персональные данные Пользователя только в случае их заполнения
                                ...
                                сайте truetws.ru. Заполняя соответствующие формы и/или отправляя свои персональные
                        ...
                        <h3 class="policy-text__section">6. Порядок сбора, хранения, передачи и других видов обработки
                        ...
                        <ol>
                            ...
                            <li>В случае выявления неточностей в персональных данных, Пользователь может актуализировать
                                ...
                                Оператора admin@truetws.ru с пометкой «Актуализация персональных данных».
                            </li>
                            <li>Срок обработки персональных данных является неограниченным. Пользователь может в любой
                                ...
                                admin@truetws.ru с пометкой «Отзыв согласия на обработку персональных данных».
                            </li>
                        </ol>


                        <h3 class="policy-text__section">7. Трансграничная передача персональных данных</h3>
                        ...
                        <h3 class="policy-text__section">8. Заключительные положения</h3>
